...
// sanitizeKey strips any directory part from a caller-supplied key. Keys are
// generated by NewKey and never contain one, but these methods take whatever
// they are handed, and "../../secret" should not reach a storage backend.
func sanitizeKey(key string) string {
	return path.Base(path.Clean("/" + key))
}
